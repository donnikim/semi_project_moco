	...
	<div id="info">
		...
		<fieldset>
				...
				<table>
					<tr>
						<td>과정명*:</td>
						<td><input type="text" style="width:300px; height:30px;" name="infoClassName" required value="${ info.infoClassName }"></td>
						<td>학원명*:</td>
						<td><input type="text" style="width:300px; height:30px;" name="infoAcademyName"required value="${ info.infoAcademyName }"></td>	
					</tr>
					<tr>
						<td>기간명*:</td>
						<td><input type="text" style="width:300px; height:30px;" name="infoPeriod" required value="${ info.infoPeriod }"></td>
						<td>요일 및 시간*:</td>
						<td><input type="text" style="width:300px; height:30px;" name="infoTime" required value="${ info.infoTime }"></td>	
					</tr>
					<tr>
						<td>담당자 성명*:</td>
						<td><input type="text" style="width:300px; height:30px;" name="infoManager" required value="${ info.infoManager }"></td>
						<td>구분*:</td>
						<td>
							<select style="width:300px; height:30px;" name="infoCategory" required>
								<option>--구분--</option>
								<option <c:if test="${ info.infoCategory == '국비학원' }">selected</c:if>>국비학원</option>
								<option <c:if test="${ info.infoCategory == '부트캠프' }">selected</c:if>>부트캠프</option>
							</select>
						</td>
					</tr>
						<tr>
