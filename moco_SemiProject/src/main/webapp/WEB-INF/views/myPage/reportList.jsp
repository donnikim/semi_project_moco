   ...
   <div class="listTable">
      ...
      <div class="table">
         <table>
            ...
            <tbody id="tbody">
               <c:forEach items="${ myInfoReportListView }" var="b">
                  <tr>
               ...
               <c:if test="${ !empty myInfoReportListView }">
                  <c:if test="${ myInfoReportListView.size()<10 }">
                     <c:forEach begin="0" end="${ 9-myInfoReportListView.size() }">
                        <tr>
